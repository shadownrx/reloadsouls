...
const description =
  "TMZA — nuevo single de Reload Souls. Ya disponible en SoundCloud.";

export const metadata: Metadata = {
  title: "TMZA — Reload Souls",
  description,
  openGraph: {
...
export default function TmzaPage() {
  return (
    <main className="relative min-h-[100svh] overflow-hidden bg-void text-bone">
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_50%_0%,rgba(196,18,47,0.2),transparent_50%)]"
      />
